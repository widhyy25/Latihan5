package latihan5.example.com.latihan5;
...
public class MainActivity extends AppCompatActivity {
    String[] hewan = {"kuda", "sapi", "kambing", "domba", "kerbau", "semut", "ikan", "ayam", "bebek", "jerapah", "harimau", "burung", "ular"};
    ListView lvHewan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvHewan.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String pilihan;
                pilihan = (String) parent.getAdapter().getItem(position).toString();
